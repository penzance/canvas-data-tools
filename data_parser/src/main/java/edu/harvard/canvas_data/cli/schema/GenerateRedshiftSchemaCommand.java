...
import edu.harvard.data.client.generators.RedshiftSchemaGenerator;

public class GenerateRedshiftSchemaCommand implements Command {
  ...
  public ReturnStatus execute(final Configuration config, final PrintStream out)
    ...
    final RedshiftSchemaGenerator generator = new RedshiftSchemaGenerator(schema);
