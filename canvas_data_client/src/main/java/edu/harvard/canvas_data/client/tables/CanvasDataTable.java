...
public abstract class CanvasDataTable {
  ...
  protected static final DateTimeFormatter CANVAS_DATA_TIMESTAMP_FORMAT = new DateTimeFormatterBuilder()
  ...
  protected final DateTimeFormatter CANVAS_DATA_ALL_DAY_FORMAT = DateTimeFormatter
      .ofPattern("yyyy-MM-dd");

  public static final CSVFormat CANVAS_DATA_FILE_FORMAT = CSVFormat.TDF.withQuote(null)
  ...
  protected String formatTimestamp(final LocalDate date) {
    if (date == null) {
      return null;
    }
