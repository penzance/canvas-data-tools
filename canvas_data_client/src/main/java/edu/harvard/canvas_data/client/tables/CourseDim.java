...
public class CourseDim extends CanvasDataTable {
  private Long id;
  ...
  public CourseDim(final CSVRecord record) {
    ...
    if ($concludeAt != null && $concludeAt.length() > 0) {
      this.concludeAt = ZonedDateTime.parse($concludeAt, CANVAS_DATA_TIMESTAMP_FORMAT);
    }
  ...
  @Override
    ...
    fields.add(formatTimestamp(concludeAt));
